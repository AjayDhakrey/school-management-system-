      ...
      <div className="panel">
        <div className="flex flex-col gap-3 border-b border-border p-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          ...
          {hasSelection && (
            <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
              ...
              <FilterSelect value={statusFilter} onChange={setStatusFilter} options={["Active", "Inactive"]} placeholder="Status" />
            </div>
          )}
        </div>
        ...
        {!hasSelection ? (
          <EmptyState
            ...
            description="Choose a class and section above to load and manage its students."
          />
        ) : isLoading ? (
