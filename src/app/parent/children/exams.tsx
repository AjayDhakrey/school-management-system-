...
import { useExamsFor, isUpcomingExam, isCompletedExam } from "@/hooks/useApi";
...
export default function ParentExamsPage() {
  ...
  const upcomingCount = rows.filter(isUpcomingExam).length;
  const completedCount = rows.filter(isCompletedExam).length;
