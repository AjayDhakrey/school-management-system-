          ...
          filtered.map((n) => {
            ...
            return (
              <button
                key={n.id}
                onClick={() => {
                  if (!isRead) void toggleRead(n.id);
                  // A notice notification only carries the title; open the notice list to read it.
                  if (n.category === "Notices") navigate("/notices");
                }}
                className={cn(
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {n.category === "Notices" && (
                    <p className="mt-0.5 text-xs font-medium text-primary">Open notice</p>
                  )}
                </div>
