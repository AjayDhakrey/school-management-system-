...
export const NAV: NavGroup[] = [
  ...
  },
  {
    label: "My Children",
    items: [
      { label: "Child Profile", to: "/parent/children/profile", icon: UserSquare2, roles: ["Parent"] },
      { label: "Attendance", to: "/parent/children/attendance", icon: ClipboardCheck, roles: ["Parent"] },
      { label: "Timetable", to: "/parent/children/timetable", icon: CalendarClock, roles: ["Parent"] },
  ...
  },
  {
    label: "Academics",
    items: [
      { label: "My Subjects", to: "/my-subjects", icon: BookOpen, roles: ["Student"], hideFromSidebar: ["Student"] },
      {
  ...
  {
    label: "",
    items: [{ label: "Holidays", to: "/holidays", icon: CalendarHeart, roles: ["Student", "Parent"], hideFromSidebar: ["Student"] }],
  },
  {
    label: "Fees & Finance",
    items: [
  ...
  },
  {
    label: "Communication",
    items: [
      { label: "Notices", to: "/notices", icon: Megaphone, roles: ALL_SCHOOL, hideFromSidebar: ["Student"] },
      { label: "Announcements", to: "/announcements", icon: Bell, roles: ALL_SCHOOL },
      { label: "Notifications", to: "/notifications", icon: Bell, roles: ["Student", "Teacher", "Parent"] },
    ],
  },
  {
    label: "School Services",
    items: [
      { label: "Library", to: "/library", icon: Library, roles: [...admins, "Librarian", "Student"] },
      { label: "Transport", to: "/transport", icon: Bus, roles: [...admins, "Transport Manager", "Student"] },
      { label: "Certificates & Documents", to: "/certificates", icon: FileText, roles: [...admins, "Student"] },
      { label: "Parents", to: "/parents", icon: Users, roles: [...admins, "Teacher"], hideFromSidebar: ["Teacher"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "School Settings", to: "/settings", icon: Settings, roles: ALL_SCHOOL.filter((r) => r !== "Student" && r !== "Parent") },
    ],
  },
  {
    label: "System",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "School Admins", to: "/super-admin/school-admins", icon: UserCog, roles: ["Super Admin"] },
      { label: "Leads & Onboarding", to: "/super-admin/leads", icon: UserPlus, roles: ["Super Admin"] },
      { label: "Subscriptions", to: "/super-admin/subscriptions", icon: CreditCard, roles: ["Super Admin"] },
      { label: "Plans & Features", to: "/super-admin/plans", icon: Layers, roles: ["Super Admin"] },
      { label: "Revenue & Payments", to: "/super-admin/revenue", icon: IndianRupee, roles: ["Super Admin"] },
      { label: "Renewals", to: "/super-admin/renewals", icon: RefreshCw, roles: ["Super Admin"] },
      { label: "Support Center", to: "/super-admin/support", icon: LifeBuoy, roles: ["Super Admin"] },
      { label: "Announcements", to: "/super-admin/announcements", icon: Megaphone, roles: ["Super Admin"] },
      { label: "Feature Control", to: "/super-admin/features", icon: ToggleLeft, roles: ["Super Admin"] },
      { label: "Security & Audit", to: "/super-admin/security", icon: ShieldCheck, roles: ["Super Admin"] },
...
export const SCHOOL_ADMIN_NAV: NavGroup[] = [
  {
    label: "",
    items: [{ label: "Dashboard", to: "/school-admin/dashboard", icon: LayoutDashboard, roles: ["School Admin"] }],
  },
  {
    label: "Student Management",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Non-Teaching Staff", to: "/non-teaching-staff", icon: Users, roles: ["School Admin"] },
    ],
  },
  {
    label: "Academics",
    items: [
      ...
      { label: "Examinations", to: "/examinations", icon: FileSpreadsheet, roles: ["School Admin"] },
      { label: "Transport", to: "/transport", icon: Bus, roles: ["School Admin"] },
      { label: "Certificates & Documents", to: "/certificates", icon: FileText, roles: ["School Admin"] },
...
export function navForRole(role: Role): NavGroup[] {
  ...
  return NAV.map((g) => ({
    ...g,
    items: g.items.filter((i) => (!i.roles || i.roles.includes(role)) && !i.hideFromSidebar?.includes(role)),
